...
function calc() {
  ...
  var sex, height, weigth, age, ratio;
...
function slider(_ref) {
  ...
  next.addEventListener('click', function () {
    if (offset === replaceWithRegular(width, /\D/g, '') * (slides.length - 1)) {
      offset = 0;
    } else {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-06-08');

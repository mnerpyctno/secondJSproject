window.addEventListener('DOMContentLoaded', () => {
    ...
    new MenuCard(
        ...
        'Меню "Постное"',
        'Меню “Постное” - ' +
        'это тщательный подбор ингредиентов: ' +
        'полное отсутствие продуктов животного ' +
        'происхождения, молоко из миндаля, овса, ' +
        'кокоса или гречки, правильное количество белков ' +
